...
@router.message(Command('send', prefix='/'))
...
@router.message(SenderMsg.text, F.text)
...
@router.message(SenderMsg.photo, F.photo)
...
@router.message(SenderMsg.btn_text, F.text)
...
@router.message(SenderMsg.btn_url, F.text)
