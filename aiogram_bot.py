...
from source.handlers.commands import ban, sender, start, check_result, add, help, report_author, report_bug
...
def set_handlers():
    ...
    dp.message.register(add.handle_send_add_russian, Command('add', prefix='/'), IsPrivate())
